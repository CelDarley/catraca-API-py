#!/usr/bin/env python3
"""
qrcode_gate_redis.py - Leitura contínua de QR Code com Redis - Raspberry Pi 5
Aciona saída quando QR Code autorizado é detectado (versão otimizada com Redis)
"""
